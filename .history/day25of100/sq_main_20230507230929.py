...
fur_color_data = data_from_sq["Primary Fur Color" == "Gray"]

print(fur_color_data)

# Filter the data based on a string condition
filtered_data = data_from_sq[data_from_sq['Primary Fur Color'].str.contains('desired_string', case=False)]
