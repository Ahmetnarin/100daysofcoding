...
fur_color_data = data_from_sq[data_from_sq["Primary Fur Color"]]
...
gray = [d["Gray"] for d in my_list]
cinnamon = [i["Cinnamon"] for i in my_list]
black = [j["Black"] for j in my_list]
