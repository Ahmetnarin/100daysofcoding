...
for name in names:
    ...
    with open(f'C://Users//AHNARIN//Desktop//Ahnarin//100_days_of_coding//day24of100//mail+merge+Project//working_with_text_file//Readytosend/Letter_to_{name.replace(" ", "_").lower()}.txt', "w") as f:
        f.write(letter)  

    with open(f'C://Users//AHNARIN//Desktop//Ahnarin//100_days_of_coding//day24of100//mail+merge+Project//working_with_text_file//Readytosend/Letter_to_{name.replace(" ", "_").lower()}.txt', "r") as f:
        temp = f.read()  

    event_date = temp.replace("[date]", "17/05/2023")
    ...
    location = temp.replace("[location]", "Istanbul")
    ...
    your_name = temp.replace("[Your Name]", "Ahmet Narin")
